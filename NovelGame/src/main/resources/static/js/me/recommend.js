...
function pageSplit(pageSize,pageNum){
		$.ajax({
		type: 'GET',
		url: "/pageApi/recommend/"+pageSize+"/"+pageNum,
...
function loadBookUpdateInfoData(bookUpdateInfoData){
		...
		rowSpan1.className="sm";rowSpan1.innerHTML="小说名称";
		rowSpan2.className="zj";rowSpan2.innerHTML="最新章节";
		rowSpan3.className="zz";rowSpan3.innerHTML="作者";
		rowSpan4.className="sj";rowSpan4.innerHTML="更新";
		rowSpan5.className="zt";rowSpan5.innerHTML="状态";
	...
	$.each(bookUpdateInfoData,function(index,n){
		...
		rowSpan1.className="sm";rowSpan1.innerHTML="<a href='/book/"+bookUpdateInfoData[index].bookNameEn+"'  ><b>"+bookUpdateInfoData[index].bookName+"</b></a>";
		rowSpan2.className="zj";rowSpan2.innerHTML="&nbsp;<a href='/book/"+bookUpdateInfoData[index].bookNameEn+"/"+bookUpdateInfoData[index].storeId+"/'  >"+bookUpdateInfoData[index].storeName+"</a>";
		rowSpan3.className="zz";rowSpan3.innerHTML="<a href='/author/"+bookUpdateInfoData[index].authorNameEn+"/'  >"+bookUpdateInfoData[index].authorName+"</a>";
		rowSpan4.className="sj";rowSpan4.innerHTML=arrayTime[1]+"/"+arrayTime[2];
		rowSpan5.className="zt";rowSpan5.innerHTML=bookUpdateInfoData[index].isCompletion==0?"已完结":"连载中";
