...
public class BattleLogger implements Logger
{
    ...
    public boolean isErrorEnabled() {
        return BattleLogger.log.isErrorEnabled();
    }
    
    @Override
    public boolean isFatalEnabled() {
        return BattleLogger.log.isFatalEnabled();
    }
    
    @Override
    public boolean isInfoEnabled() {
        return BattleLogger.log.isInfoEnabled();
    }
    
    @Override
    public boolean isWarnEnabled() {
        return BattleLogger.log.isWarnEnabled();
    }
}
