...
public class TaskRewardQueSheQiang implements ITaskReward
{
    private static final DayReportLogger logger;
    private int num;
    private final int ITEM_ID = 1041;
    ...
    public TaskRewardQueSheQiang(final int num) {
        this.num = num;
    }
    
    public TaskRewardQueSheQiang(final String[] s) {
        if (s.length > 1) {
    ...
    public Map<Integer, Reward> rewardPlayer(final PlayerDto playerDto, final IDataGetter taskDataGetter, final String prefixAttribute, final Object obj) {
        final Equip item = (Equip)taskDataGetter.getEquipCache().get((Object)1041);
        ...
        for (int i = 0; i < this.num; ++i) {
            ...
            TaskRewardQueSheQiang.logger.info(LogUtil.formatEquipLog(player, "+", "\u83b7\u5f97", true, item, sh, prefixAttribute));
        }
    ...
    public Map<Integer, Reward> getReward(final PlayerDto playerDto, final IDataGetter taskDataGetter, final Object obj) {
        ...
        map.put(44, new Reward(44, "quesheqiang", this.num));
        return map;
    }
}
