...
public class TaskRewardTianHeJia implements ITaskReward
{
    private static final DayReportLogger logger;
    private int num;
    private final int ITEM_ID = 3041;
    ...
    public TaskRewardTianHeJia(final int num) {
        this.num = num;
    }
    
    public TaskRewardTianHeJia(final String[] s) {
        if (s.length > 1) {
    ...
    public Map<Integer, Reward> rewardPlayer(final PlayerDto playerDto, final IDataGetter taskDataGetter, final String prefixAttribute, final Object obj) {
        final Equip item = (Equip)taskDataGetter.getEquipCache().get((Object)3041);
        ...
        for (int i = 0; i < this.num; ++i) {
            ...
            TaskRewardTianHeJia.logger.info(LogUtil.formatEquipLog(player, "+", "\u83b7\u5f97", true, item, sh, prefixAttribute));
        }
    ...
    public Map<Integer, Reward> getReward(final PlayerDto playerDto, final IDataGetter taskDataGetter, final Object obj) {
        ...
        map.put(45, new Reward(45, "tianhejia", this.num));
        return map;
    }
}
