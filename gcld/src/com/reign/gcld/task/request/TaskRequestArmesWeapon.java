...
public class TaskRequestArmesWeapon extends TaskRequestCount
{
    public TaskRequestArmesWeapon(final String[] s) {
        super(1);
    }
    
    @Override
    public void handleMessage(final TaskMessage message, final IDataGetter dataGetter, final int vId) {
        if (message instanceof TaskMessageArmesWeapon) {
    ...
    public boolean isConcernedMessage(final TaskMessage message) {
        return message instanceof TaskMessageArmesWeapon;
    }
}
