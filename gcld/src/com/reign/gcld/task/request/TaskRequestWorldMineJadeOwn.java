...
public class TaskRequestWorldMineJadeOwn extends TaskRequestCount
{
    public TaskRequestWorldMineJadeOwn(final String[] s) {
        super(1);
    }
    
    @Override
    public void handleMessage(final TaskMessage message, final IDataGetter taskDataGetter, final int vId) {
        if (message instanceof TaskMessageWorldMineJadeOwn) {
    ...
    public boolean isConcernedMessage(final TaskMessage message) {
        return message instanceof TaskMessageWorldMineJadeOwn;
    }
}
