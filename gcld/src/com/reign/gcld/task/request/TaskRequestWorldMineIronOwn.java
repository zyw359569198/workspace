...
public class TaskRequestWorldMineIronOwn extends TaskRequestCount
{
    public TaskRequestWorldMineIronOwn(final String[] s) {
        super(1);
    }
    
    @Override
    public void handleMessage(final TaskMessage message, final IDataGetter taskDataGetter, final int vId) {
        if (message instanceof TaskMessageWorldMineIronOwn) {
    ...
    public boolean isConcernedMessage(final TaskMessage message) {
        return message instanceof TaskMessageWorldMineIronOwn;
    }
}
