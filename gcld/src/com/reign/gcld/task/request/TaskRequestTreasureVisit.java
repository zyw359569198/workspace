...
public class TaskRequestTreasureVisit extends TaskRequestCount
{
    public TaskRequestTreasureVisit(final String[] s) {
        super(1);
    }
    
    @Override
    public void handleMessage(final TaskMessage message, final IDataGetter taskDataGetter, final int vId) {
        if (message instanceof TaskMessageTreasureVisit) {
    ...
    public boolean isConcernedMessage(final TaskMessage message) {
        return message instanceof TaskMessageTreasureVisit;
    }
}
