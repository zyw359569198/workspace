...
public class TaskRequestGetSalary extends TaskRequestCount
{
    public TaskRequestGetSalary(final String[] s) {
        super(1);
    }
    
    @Override
    public void handleMessage(final TaskMessage message, final IDataGetter taskDataGetter, final int vId) {
        if (message instanceof TaskMessageGetSalary) {
    ...
    public boolean isConcernedMessage(final TaskMessage message) {
        return message instanceof TaskMessageGetSalary;
    }
}
