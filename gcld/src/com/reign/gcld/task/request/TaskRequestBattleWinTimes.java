...
public class TaskRequestBattleWinTimes extends TaskRequestCount
{
    public TaskRequestBattleWinTimes(final String[] s) {
        super(s);
    }
    
    @Override
    public void handleMessage(final TaskMessage message, final IDataGetter taskDataGetter, final int vId) {
        if (message instanceof TaskMessageBattleWinTimes) {
    ...
    public boolean isConcernedMessage(final TaskMessage message) {
        return message instanceof TaskMessageBattleWinTimes;
    }
