...
public class TaskRequestHallsVisit extends TaskRequestCount
{
    public TaskRequestHallsVisit(final String[] s) {
        super(1);
    }
    
    @Override
    public void handleMessage(final TaskMessage message, final IDataGetter taskDataGetter, final int vId) {
        if (message instanceof TaskMessageHallsVisit) {
    ...
    public boolean isConcernedMessage(final TaskMessage message) {
        return message instanceof TaskMessageHallsVisit;
    }
}
