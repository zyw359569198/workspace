...
public class TaskRequestEventDaily extends TaskRequestCount
{
    public TaskRequestEventDaily(final String[] s) {
        super(1);
    }
    
    @Override
    public void handleMessage(final TaskMessage message, final IDataGetter taskDataGetter, final int vId) {
        if (message instanceof TaskMessageEventDaily) {
    ...
    public boolean isConcernedMessage(final TaskMessage message) {
        return message instanceof TaskMessageEventDaily;
    }
}
