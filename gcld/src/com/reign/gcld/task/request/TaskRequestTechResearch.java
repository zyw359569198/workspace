...
public class TaskRequestTechResearch extends TaskRequestCount
{
    public TaskRequestTechResearch(final String[] s) {
        super(1);
    }
    
    @Override
    public void handleMessage(final TaskMessage message, final IDataGetter taskDataGetter, final int vId) {
        if (message instanceof TaskMessageTechResearch) {
    ...
    public boolean isConcernedMessage(final TaskMessage message) {
        return message instanceof TaskMessageTechResearch;
    }
}
