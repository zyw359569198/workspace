...
public class TaskRequestOfficerHarvest extends TaskRequestCount
{
    public TaskRequestOfficerHarvest(final String[] s) {
        super(1);
    }
    
    @Override
    public void handleMessage(final TaskMessage message, final IDataGetter taskDataGetter, final int vId) {
        if (message instanceof TaskMessageOfficerHarvest) {
    ...
    public boolean isConcernedMessage(final TaskMessage message) {
        return message instanceof TaskMessageOfficerHarvest;
    }
}
