...
public class TaskRequestVisitArea extends TaskRequestCount
{
    private int areaId;
    
    public TaskRequestVisitArea(final String[] s) {
        super(1);
    ...
    public void handleMessage(final TaskMessage message, final IDataGetter taskDataGetter, final int vId) {
        if (message instanceof TaskMessageVisitArea) {
            final TaskMessageVisitArea taskMessageVisitArea = (TaskMessageVisitArea)message;
            if (taskMessageVisitArea.getAreaId() == this.areaId) {
    ...
    public boolean isConcernedMessage(final TaskMessage message) {
        return message instanceof TaskMessageVisitArea;
    }
}
