...
public class TaskRequestFireGeneral extends TaskRequestCount
{
    public TaskRequestFireGeneral(final String[] s) {
        super(1);
    }
    
    @Override
    public void handleMessage(final TaskMessage message, final IDataGetter taskDataGetter, final int vId) {
        if (message instanceof TaskMessageFireGeneral) {
    ...
    public boolean isConcernedMessage(final TaskMessage message) {
        return message instanceof TaskMessageFireGeneral;
    }
}
