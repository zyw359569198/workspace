...
public class TaskRequestBlackMarketBuy extends TaskRequestCount
{
    public TaskRequestBlackMarketBuy(final String[] s) {
        super(1);
    }
    
    @Override
    public void handleMessage(final TaskMessage message, final IDataGetter taskDataGetter, final int vId) {
        if (message instanceof TaskMessageBlackMarketBuy) {
    ...
    public boolean isConcernedMessage(final TaskMessage message) {
        return message instanceof TaskMessageBlackMarketBuy;
    }
}
