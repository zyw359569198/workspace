...
public class NationTaskExpeditionArmy implements IModel
{
    ...
    public static final int NATION_TASK_ARMY_TYPE_1 = 1;
    public static final int NATION_TASK_ARMY_TYPE_2 = 2;
