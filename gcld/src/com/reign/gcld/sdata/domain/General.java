...
public class General implements IModel
{
    ...
    private String sp;
    private String spI;
    private GeneralSpecialInfo generalSpecialInfo;
    
    public GeneralSpecialInfo getGeneralSpecialInfo() {
        return this.generalSpecialInfo;
    }
    
    public void setGeneralSpecialInfo(final GeneralSpecialInfo generalSpecialInfo) {
