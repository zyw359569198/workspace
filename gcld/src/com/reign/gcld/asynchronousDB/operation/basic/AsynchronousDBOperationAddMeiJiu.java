...
public class AsynchronousDBOperationAddMeiJiu extends AsynchronousDBOperationBase
{
    private int playerId;
    private int num;
    private Object attribute;
    
    public AsynchronousDBOperationAddMeiJiu(final int playerId, final int num, final Object attribute) {
    ...
    public void handleOperation(final IDataGetter dataGetter) {
        ...
        dataGetter.getEventService().addXo(this.playerId, this.num, this.attribute.toString());
    }
    
    @Override
    public String getOperationInfo() {
        return MessageFormatter.format("xo#{0}#{1};", new Object[] { this.playerId, this.num });
    }
}
