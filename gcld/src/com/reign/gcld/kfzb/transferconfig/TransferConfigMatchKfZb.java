package com.reign.gcld.kfzb.transferconfig;
...
public class TransferConfigMatchKfZb extends TransferConfig
{
    ...
    public TransferConfigMatchKfZb(final String host, final int port) {
